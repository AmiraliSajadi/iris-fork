...
class LLM:
    ...
    def predict_main(self, prompt, batch_size=0, no_progress_bar=False):
        if self.kwargs.get("vllm", None):
            ...
            params = SamplingParams(
                ...
                max_tokens=self.model_hyperparams["max_new_tokens"],
            )
        ...
        if self.kwargs.get("flash"):
            ...
            if batch_size > 0:
                ...
                class ListDataset(Dataset):
                    ...
                    def take(self, m, n=0):
                        return ListDataset(self.original_list[n:m])
    ...
    def get_llm(model_name, kwargs, logger):
        ...
        elif model_name.lower().startswith("mistral") or model_name.lower().startswith(
            "mixtral"
        ):
